...
const pizzas = ref([
  ...
  */
  ...
  },
  {
    ...
    prices: { P: 42.0, G: 55.0 },
  },
  {
    id: 41,
    name: "Lombinho",
    image: "/pizzas/lombinho.webp",
    category: "PROMOCAO",
    ingredients: [
      "MOLHO DE TOMATE",
      "MUSSARELA",
...
const isOrderingAvailable = computed(() => {
  ...
  return (day >= 5 || day === 0) && minutes >= 8 * 60 && minutes <= 22 * 60 + 40;
});
  ...
  <div class="pizzaria-app">
    <div v-if="!isOrderingAvailable" class="ordering-closed-overlay">
      <div class="ordering-closed-message" role="alert">
        ...
        <p>Atendemos de sexta a domingo, das 08:00 às 22:40.</p>
          ...
          <div v-else>
            <div v-for="item in cart" :key="item.id" class="modal-cart-item">
              <div class="item-details">
                ...
                <p
                  v-else-if="item.pizza.category === 'BEBIDA'"
                  class="item-info"
                >
                  Bebida: 1L
                </p>
...
@keyframes promo-glow {
  ...
  50% {
    box-shadow:
      0 4px 20px rgba(255, 78, 0, 0.6),
      0 0 35px rgba(236, 159, 5, 0.4);
  }
}
...
.promo-icon {
  font-size: 1rem;
  animation: promo-fire 0.8s ease-in-out infinite alternate;
}
